...
public class AdapterIncomingFriendRequests extends RecyclerView.Adapter<AdapterIncomingFriendRequests.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            userDisplay = itemView.findViewById(R.id.requesterTextView);
            ImageButton accept = itemView.findViewById(R.id.acceptButton);
            ImageButton remove = itemView.findViewById(R.id.denyButton);
            accept.setOnClickListener(view -> {
                try {
                    clickListener.onPositionClick(userDisplay.getText().toString(), accept.getId());
            ...
            remove.setOnClickListener(view -> {
                try {
                    clickListener.onPositionClick(userDisplay.getText().toString(), remove.getId());
                } catch (JSONException | NoSuchAlgorithmException | IOException e) {
                    throw new RuntimeException(e);
                }
            });
    ...
    public AdapterIncomingFriendRequests(JSONObject jsonObject,
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recycler_incoming_friend_requests_list, parent, false));
    }
    ...
    public interface OnClickListener {
        void onPositionClick(String requester, int id) throws JSONException, NoSuchAlgorithmException, IOException;
    }
}
